...
@main.route("/customers", methods=['POST', 'GET'])
def customers():
    db_connection = connect_to_database()
    alerts = ()
...
@main.route("/coupons", methods=['POST', 'GET'])
def coupons():
    db_connection = connect_to_database()
    alerts = ()
...
@main.route("/orders_products", methods=['GET', 'POST'])
def orders_products():
...
@main.route("/coupons_customers", methods=['POST', 'GET'])
...
@main.route("/delete_coupon/<int:id>")
...
@main.route("/orders/update/<int:id>", methods=['POST', "GET"])
def update_order(id):
    db_connection = connect_to_database()
    alerts = ()
